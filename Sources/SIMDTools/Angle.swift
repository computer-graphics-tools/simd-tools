...
extension Angle {
    ...
    public static func %(lhs: Angle, rhs: Angle) -> Angle {
        Angle(lhs.degrees.truncatingRemainder(dividingBy: rhs.degrees))
    }
